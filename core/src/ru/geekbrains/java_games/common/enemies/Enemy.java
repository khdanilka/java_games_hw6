    ...
    public void update(float deltaTime) {
        ...
        switch (state) {
            ...
            case FIGHT:
                ...
                if (isMainShipCollision()) {
                    System.out.println("случилось столкновение с осноным кораблем");
                    boom();
                    destroy();
                    mainShip.boom();
                    mainShip.destroy();
...
//    }
    ...
    public boolean isMainShipCollision () {
        return !(mainShip.getRight() < getLeft() || mainShip.getLeft() > getRight() || mainShip.getBottom() > getTop() || mainShip.getTop() < pos.y);
    }
